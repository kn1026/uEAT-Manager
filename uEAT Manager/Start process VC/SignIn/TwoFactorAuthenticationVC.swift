                ...
                for item in snap!.documents {
                    ...
                    DataService.instance.mainFireStoreRef.collection("Restaurant_check_list").whereField("Restaurant_id", isEqualTo: id).whereField("Menu", isEqualTo: true).getDocuments { (snapCheck, err) in
                        ...
                        if snapCheck?.isEmpty == true {
                            ...
                            _ = alert.addButton("Start creating") {
                                
                                
                                self.performSegue(withIdentifier: "MoveToCreateMenuVC", sender: nil)
                            ...
                            _ = alert.showCustom("Congratulations!", subTitle: "In order to start selling, you will need to create your menu", color: UIColor.black, icon: icon!)
